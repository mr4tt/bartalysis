...
CREATE TABLE fare_rule (
    fare_id INT PRIMARY KEY REFERENCES fare_attribute(fare_id),
    route_id TEXT,
...
CREATE TABLE fare_rider_category (
    ...
    rider_category_id INT REFERENCES rider_category(rider_category_id),
    price INT NOT NULL
);
